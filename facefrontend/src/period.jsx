...
const Period = () => {
  ...
  const periods = [
    ...
    { name: 'Python', icon: <FaPython className="text-3xl text-blue-500" />, time: '10:10 AM' },
    { name: 'Networking', icon: <FaNetworkWired className="text-3xl text-green-600" />, time: '11:20 AM' },
